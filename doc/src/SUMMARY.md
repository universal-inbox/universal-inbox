...
- [Access Universal Inbox](quick_start/README.md)
- [Connecting Your Tools](quick_start/first_connection.md)
- [The Inbox Screen](quick_start/inbox_screen.md)
- [The Synced Tasks Screen](quick_start/synced_tasks_screen.md)
...
- [Collecting notifications](how/collecting_notifications.md)
- [Synchronizing tasks](how/synchronizing_tasks.md)
- [Actions by integration](how/actions/README.md)
  - [Github](how/actions/github.md)
  - [Google Mail](how/actions/gmail.md)
