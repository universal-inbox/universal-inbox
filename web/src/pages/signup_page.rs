        ...
        div {
            ...
            if is_local_auth_enabled {
                ...
                if is_google_auth_enabled {
                    { google_signup_section(api_base_url) }
                }

                if is_passkey_auth_enabled {
                    { passkey_signup_section() }
                }
            }
...
fn google_signup_section(api_base_url: Memo<url::Url>) -> Element {
...
fn google_signup_section(_api_base_url: Memo<url::Url>) -> Element {
    rsx! {}
}

#[cfg(feature = "web")]
fn passkey_signup_section() -> Element {
