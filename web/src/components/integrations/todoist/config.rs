...
use universal_inbox::{
    integration_connection::{
        ...
        integrations::{task_time_config::TaskTimeConfig, todoist::TodoistConfig},
...
pub fn TodoistProviderConfiguration(
    ...
    rsx! {
        SettingRow {
            label: rsx! { "Synchronize Todoist tasks" },
            ToggleSwitch {
                size: ToggleSize::Md,
        ...
        div {
            ...
            SettingRow {
                ...
                ProjectSearchField {
                    ...
                    provider_kind: Some(IntegrationProviderKind::Todoist),
