...
use crate::helpers::{
    ...
    task::{
        ...
        ticktick::{
            ...
            mock_ticktick_list_projects_service, mock_ticktick_list_tasks_service,
            ticktick_projects_response, ticktick_tasks_response,
        },
    },
};
...
async fn test_sync_ticktick_tasks_should_add_new_task_and_update_existing_one(
    ...
    mock_ticktick_list_projects_service(&app.app.ticktick_mock_server, &ticktick_projects_response)
        .await;
    // list_all_tasks now pulls the TickTick inbox as well; return empty for the fixture data.
