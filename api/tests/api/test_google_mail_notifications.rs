...
use crate::helpers::notification::google_mail::google_mail_thread_get_123;
...
use crate::helpers::{
    ...
    notification::google_mail::mock_google_mail_thread_modify_service,
...
mod patch_resource {
    use universal_inbox::notification::integrations::google_mail::{
        GoogleMailThread, GOOGLE_MAIL_INBOX_LABEL,
    };
    ...
    async fn test_patch_google_mail_notification_status_as_deleted(
        ...
        let expected_notification =
            Box::new(google_mail_thread_get_123.into_notification(app.user.id, None));
            ...
            when.method(POST)
                ...
                .body(
                    json!({
                        ...
                        "removeLabelIds": vec![GOOGLE_MAIL_INBOX_LABEL]
                    })
                    .to_string(),
                )
