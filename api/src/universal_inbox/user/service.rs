...
impl UserService {
    ...
    pub async fn add_local_auth_method(
        ...
        if self
            .repository
            .get_user_auth_for_kind(executor, user_id, UserAuthKind::Local)
            .await?
            .is_some()
        {
    ...
    pub async fn start_add_passkey_auth_method(
        ...
        if self
            .repository
            .get_user_auth_for_kind(executor, user_id, UserAuthKind::Passkey)
            .await?
            .is_some()
        {
            return Err(UniversalInboxError::AlreadyExists {
    ...
    pub async fn link_oidc_auth_method(
        ...
        if self
            .repository
            .get_user_auth_for_kind(executor, user_id, kind)
            .await?
            .is_some()
        {
            return Err(UniversalInboxError::AlreadyExists {
