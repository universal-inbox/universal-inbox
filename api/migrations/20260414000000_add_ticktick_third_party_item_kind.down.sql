...
CREATE TYPE third_party_item_kind_new AS ENUM ('TodoistItem', 'LinearIssue', 'SlackReaction', 'LinearNotification', 'GithubNotification', 'GoogleMailThread', 'GoogleCalendarEvent', 'WebPage', 'SlackThread', 'GoogleDriveComment');
