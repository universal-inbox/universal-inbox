CREATE TYPE integration_provider_kind_new AS ENUM ('Github', 'Todoist', 'Linear', 'GoogleMail', 'Slack', 'TickTick', 'GoogleCalendar');

DELETE FROM integration_connection WHERE provider_kind = 'API';
...
DELETE FROM integration_connection_config WHERE kind = 'API';

CREATE TYPE integration_connection_config_kind_new AS ENUM ('Github', 'Todoist', 'Linear', 'GoogleMail', 'Slack', 'TickTick', 'GoogleCalendar');
...
DELETE FROM third_party_item WHERE kind = 'WebPage';
CREATE TYPE third_party_item_kind_new AS ENUM ('TodoistItem', 'LinearIssue', 'SlackStar', 'SlackReaction', 'LinearNotification', 'GithubNotification', 'GoogleMailThread', 'GoogleCalendarEvent');
...
-- Remove 'API' from notification_source_kind enum
DELETE FROM notification WHERE source_kind = 'API';
CREATE TYPE notification_source_kind_new AS ENUM ('Todoist', 'Linear', 'Github', 'GoogleMail', 'Slack', 'GoogleCalendar');
