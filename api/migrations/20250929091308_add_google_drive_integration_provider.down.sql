CREATE TYPE integration_provider_kind_new AS ENUM ('Github', 'Todoist', 'Linear', 'GoogleMail', 'Slack', 'TickTick', 'GoogleCalendar', 'API');

DELETE FROM integration_connection WHERE provider_kind = 'GoogleDrive';
...
DELETE FROM integration_connection_config WHERE kind = 'GoogleDrive';

CREATE TYPE integration_connection_config_kind_new AS ENUM ('Github', 'Todoist', 'Linear', 'GoogleMail', 'Slack', 'TickTick', 'GoogleCalendar', 'API');
...
DELETE FROM third_party_item WHERE kind = 'GoogleDriveComment';
CREATE TYPE third_party_item_kind_new AS ENUM ('TodoistItem', 'LinearIssue', 'SlackStar', 'SlackReaction', 'LinearNotification', 'GithubNotification', 'GoogleMailThread', 'GoogleCalendarEvent', 'WebPage');
...
-- Remove 'GoogleDrive' from notification_source_kind enum
DELETE FROM notification WHERE source_kind = 'GoogleDrive';
CREATE TYPE notification_source_kind_new AS ENUM ('Todoist', 'Linear', 'Github', 'GoogleMail', 'Slack', 'GoogleCalendar', 'API');
